import { Beacon, BeaconInformation, BeaconIntent, Vessel } from "./types";

type BeaconUnion = Beacon & Vessel & BeaconInformation;

// Convenience type
export type CacheEntry = Partial<BeaconUnion> & {
